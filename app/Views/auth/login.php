            ...
            <div class="login__form-container">
                ...
                <form id="formulario" method="POST" class="login__form" action="<?= base_url('AutenticarUsuario'); ?>">
                    ...
                    <div class="login__input-container">
                        ...
                        <input placeholder="Ej: correo@gmail.com" name="email" type="email"
                            class="login__form-input-field" id="email" required>
                    </div>
                    ...
                    <div class="login__input-container">
                        ...
                        <input placeholder="Ej: **********" name="password" type="password"
                            class="login__form-input-field" id="password" required>
                    </div>
