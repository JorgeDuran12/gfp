...
<div class="tabla">
    ...
    <button href="#" id="agregar" onclick="selecionaRegistro(<?php echo 1 . ',' . 1 ?>);"
        class="btn btn-success regresar_Btn" data-bs-toggle="modal" data-bs-target="#editarModal" hidden
        title="Para poder registrar un saquito debera   tener un presupuesto.">Agregar</button>

    <a href=" <?php echo base_url('/proyeccion'); ?>" class="btn btn-primary regresar_Btn"
